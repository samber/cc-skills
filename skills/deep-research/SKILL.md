---
name: deep-research
description: "Deep research skill — parallel web searches, multi-source validation, confidence tracking, cited Markdown report. Supports 11 research types: market, domain, technical, competitive, product, academic, person/org, financial, legal, trend, community. Use when asked to: 'research [topic]', 'deep dive on X', 'competitive analysis', 'compare these options', 'literature review', 'background on Y', 'product teardown', 'technology evaluation', 'regulatory overview', 'funding landscape', 'patent landscape', 'community health', or any request requiring scanning many sources and producing a cited analysis. Trigger even when phrased casually: 'look into X', 'dig into Z', 'catch me up on X'. Apply whenever the deliverable is a thorough, sourced report rather than a quick answer."
user-invocable: true
license: MIT
