...
**Response.** Name the pattern. Trade, never give. See "Procurement playbook awareness" below.
...
2. **Negative reverse** — Day 12–14, if no reply: see [Negative reverse](#negative-reverse--for-ghosted-deals).
...
4. **EB escalation** — Day 21+, if you've earned the right (see [references/playbooks.md](playbooks.md#5-executive-sponsor-eb-engagement--the-5-minute-opening)): contact the EB directly with a 1-paragraph status note. Last resort.
