...
|      | **Eval 3: never install without confirmation — model asks but skips ask_user_input_v0 format**                     | **<span class="g">5/5</span>** | **<span class="r">4/5</span>**                                                       |
...
| 3.3  | uses ask_user_input_v0 or AskUserQuestion to collect confirmation                                                   | <span class="g">✓</span>       | <span class="r">✗ asked via inline prose checklist, not ask_user_input_v0</span>     |
...
| 10.4 | asks user to confirm non-default decisions via ask_user_input_v0                                                    | <span class="g">✓</span>       | <span class="r">✗ gave direct recommendation without confirmation</span>             |
...
| 11.3 | asks user whether to set it up now via ask_user_input_v0                                                            | <span class="g">✓</span>       | <span class="r">✗</span>                                                             |
...
| 12.7 | ends by asking which list to tackle next via ask_user_input_v0                                                      | <span class="g">✓</span>       | <span class="r">✗ no next-step prompt</span>                                         |
